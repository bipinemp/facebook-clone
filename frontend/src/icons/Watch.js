...
export const Watch = ({ solid1, fill1, line1 }) => {
  ...
  return (
    ...
    >
      <div
        style={line1 ? MID_ICON : MID_ACTIVE_ICON}
        onMouseEnter={() => setBg(true)}
        onMouseLeave={() => setBg(false)}
        className={line1 ? "home-icon" : null}
      >
        <svg
          viewBox="0 0 28 28"
      ...
      <span className={hover ? "link-tag" : "nonactive-link-tag"}>Posts</span>
    </div>
  );
};
